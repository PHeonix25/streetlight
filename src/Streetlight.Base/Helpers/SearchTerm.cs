...
namespace Streetlight.Base.Helpers
{
    ...
    internal class SearchTerm
    {
        ...
        public static string GetRandom() => $"{_Verbs[_r.Next(0, _Verbs.Length - 1)]}"; // {_Nato[_r.Next(0, _Nato.Length - 1)]}";
        public static string GetWithSeed(string seed) => $"{seed} {GetRandom()}";
    }
}